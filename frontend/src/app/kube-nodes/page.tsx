                                    ...
                                    >
                                        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                                            ...
                                            <div className="flex items-center gap-6 flex-wrap">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="text-sm">
                                                        ...
                                                        <span className="text-muted-foreground text-xs"> / {node.cpu_capacity} CPU</span>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <MemoryStick className="h-4 w-4 text-purple-500" />
                                                    <div className="text-sm">
                                                        <span className="font-medium">{formatMemory(node.memory_allocatable)}</span>
                                                        <span className="text-muted-foreground text-xs"> / {formatMemory(node.memory_capacity)}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex flex-col items-end min-w-[80px]">
                                                <span className="text-xs text-muted-foreground">{formatAge(node.age)}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
