...
function MutatingWebhooksContent() {
                ...
                <Card className="border-none shadow-2xl shadow-black/5 bg-card/50 backdrop-blur-sm overflow-hidden rounded-3xl">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle className="text-lg font-bold flex items-center gap-3">
                                    ...
                                    {resources.length} Mutating Webhooks Found
                                </CardTitle>
                                <CardDescription>
                                    {!selectedContext ? "Select a cluster from the top bar" : "Cluster-wide admission mutation hooks"}
                                </CardDescription>
                            </div>
                            <Button
                                variant="outline"
                    ...
                    <CardContent className="p-8">
                        {loading ? (
                            ...
                            <div className="text-center py-12">
                                <Zap className="h-12 w-12 mx-auto text-muted-foreground/30 mb-4" />
                                <p className="text-muted-foreground text-sm">No Mutating Webhooks found.</p>
                            </div>
                        ) : (
