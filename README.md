...
```bash
docker run --rm -p 8080:8080 ghcr.io/pixelvide/kube-sentinel:1.0.0
```
...
1. **Apply deployment manifests**
   ...
   kubectl apply -f https://raw.githubusercontent.com/pixelvide/kube-sentinel/refs/tags/v1.0.0/deploy/install.yaml
   ```
