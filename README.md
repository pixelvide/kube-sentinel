...
```bash
docker run --rm -p 8080:8080 ghcr.io/pixelvide/cloud-sentinel-k8s:0.6.2
```
...
1. **Apply deployment manifests**
   ...
   kubectl apply -f https://raw.githubusercontent.com/pixelvide/cloud-sentinel-k8s/refs/tags/v0.6.2/deploy/install.yaml
   ```
